...
public class AutoBasicCommandGroup extends SequentialCommandGroup {
  /**
   * Creates a new AutoBasicCommandGroup.
   */
  public AutoBasicCommandGroup(DrivetrainSubsystem drivetrainSubsystem, ShooterSubsystem shooterSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem, 
